...
namespace Strava_Centurion.FileFormats
{
    ...
    public class TcxDataSegmentReader : IDataSegmentReader
    {
        ...
        private List<DataPoint> GetDataPoints(XmlNode xmlNode, XmlNamespaceManager xmlNamespaceManager)
        {
            ...
            if (nodes != null)
            {
                foreach (XmlNode node in nodes)
                {
                    ...
                    var cadence = this.GetIntNode(node, xmlNamespaceManager, CadenceXpath);
                    ...
                    var heartrateInBpm = this.GetIntNode(node, xmlNamespaceManager, HeartrateXpath);
        ...
        private int GetIntNode(XmlNode xmlNode, XmlNamespaceManager xmlNamespaceManager, string xpath)
        {
